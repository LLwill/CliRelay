...
type OpenAICompatibility struct {
	...
	// UpstreamAPI selects the wire API used for this provider. Supported values
	// are "chat-completions", "responses", and "auto". An empty value keeps the
	// legacy Chat Completions behavior for backwards compatibility.
